...
contents = [
    ...
    " of poor quality, and with badly misregistered colors:",
    image1,
...
1.  **Color Transfer:** Every single colored area in Image 1 must be transferred to the corresponding
    area in Image 2. Do not omit any colors. If an area is colored in Image 1, it must be colored in the output. No white or uncolored areas should remain if they have color in Image 1.
...
-   **DO NOT** use any halftone patterns, dots, or textures whatsoever. Colors must be perfectly flat and smooth. This is a critical instruction.
-   **DO NOT** leave any areas uncolored that are colored in Image 1.
-   **DO NOT** change the color of any black and white lineart in Image 2.
-   **DO NOT** add any new black lines.
...
-   **Self-Correction:** Before finishing, double-check that every single area that has color in Image 1 is colored in the output.
