...
blue boy answers to DEWEY, the red boy is made cameraman). **RULED 2026-09-23: the swap is
recorded ONLY where the dialogue fixes the boy** -- 138 g14, 139 g5/g8/g9 and the
cameraman scene 141 g2/g6/g10, 7 calls. Every call resting on the cap alone uses the
convention (red Huey, green Louie): the pass first named all 26 by the swap, and 19
were put back (ee3b2a6f) because a title-wide swap multiplies the colour corrections
